...
🏆 ТОП-3 ЛУЧШИХ
1. [Название] - [%] - [цена] руб - [поставщик]
2. [Название] - [%] - [цена] руб - [поставщик]
3. [Название] - [%] - [цена] руб - [поставщик]

📋 ПОЛНЫЙ СПИСОК ([количество] товаров)

1. [Название товара] - [%]% ✅ - [цена] руб - [поставщик]
   Не соответствует: [конкретные несоответствия или "полностью соответствует"]

2. [Название товара] - [%]% ✅ - [цена] руб - [поставщик]  
   Не соответствует: [конкретные несоответствия]

[...продолжить для ВСЕХ товаров...]

🎯 РЕКОМЕНДАЦИЯ
Лучший выбор: [товар с лучшим соотношением соответствия/цены]
...
ПРОВЕРЯЙ КРИТИЧНЫЕ ПАРАМЕТРЫ - они важнее всего
ВЫДЕЛИ ТОП-3 - для быстрого обзора
УКАЗЫВАЙ ССЫЛКУ КОТОРАЯ ТЕБЕ ДАНА НА ТОВАР - НЕ ПРИДУМЫВАЙ, А УКАЗЫВАЙ ИМЕННО ТУ КОТОРАЯ ДАНА
🚫 ЗАПРЕЩЕНО:
...
💡 ЦЕЛЬ
Дать заказчику четкое понимание того, какие из найденных товаров лучше всего подходят под техническое задание тендера, с точными процентами соответствия и конкретными причинами несоответствий.
`,
