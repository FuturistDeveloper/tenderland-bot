...
🗺️ Место нахождения: [адрес]
🆔 ИНН: [ИНН или "не указан"]
👤 Ответственное лицо: [ФИО]
📧 Email: [email]
📞 Телефон: [телефон]
📠 Факс: [факс или "не указан"]
...
⚙️ Характеристики: [подробные характеристики]

🌍 НАЦИОНАЛЬНЫЙ РЕЖИМ 
[Для каждого объекта:]
📦 Объект: [код и название]
⚠️ Тип требования: [тип]
...
🛡️ ТРЕБОВАНИЯ ОБЕСПЕЧЕНИЯ 
💳 Обеспечение заявки: [сумма или "не требуется"]
🔒 Обеспечение контракта: [сумма или "не требуется"]
🛠️ Гарантийные обязательства: [срок или "не требуются"]

ℹ️ ДОПОЛНИТЕЛЬНАЯ ИНФОРМАЦИЯ 
💼 Источник финансирования: [источник]
🏛️ Наименование бюджета: [бюджет]
🔢 Код бюджетной классификации: [код]
...
Ответ должен быть строго в указанном формате с эмодзи
