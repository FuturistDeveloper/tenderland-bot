...
- Дополнительные расходы (15% к рыночной стоимости)
...
## 2. АНАЛИЗ ЗАКАЗЧИКА
ПРОАНАЛИЗИРУЙ:
- Используй реальные данные из БД (ИНН, полное название, адрес)
- Тип заказчика (государственная/муниципальная/коммерческая)
- ИЗБЕГАЙ общих фраз про надежность госструктур
...
Рыночная стоимость: [сумма] рублей
...
Сроки поставки: [конкретные сроки]
...
4. ВСЕГДА используй реальные данные заказчика из БД
5. НЕ добавляй блоки "Основные риски", "Практические рекомендации", "Итоговый вывод"
6. ИЗБЕГАЙ общих фраз и рассуждений ИИ
...
10. Фокусируйся на фактах и цифрах, минимизируй "воду"
11. СТРОГО следуй указанному формату ответа без отклонений
`,
};
